...
return {
 ...
 {name=NS.ufo_goto_previous_fold,    rhs=Wrapper.fn2(ufo.goPreviousClosedFold,ufo.peekFoldedLinesUnderCursor)},
 {name=NS.ufo_goto_next_fold,        rhs=Wrapper.fn2(ufo.goNextClosedFold,ufo.peekFoldedLinesUnderCursor)},
 {
