...
return {
 ...
 {name=NS.lsp_diagnostic_next,        rhs=HCNvim.Util.Wrapper.fn_eval(vim.diagnostic.jump,{count=1})},
 {name=NS.lsp_diagnostic_previous,    rhs=HCNvim.Util.Wrapper.fn_eval(vim.diagnostic.jump,{count=-1})},
 {name=NS.lsp_diagnostic_toggle,      rhs=HCNvim.Util.Wrapper.fn_eval(vim.diagnostic.enable,vim.diagnostic.is_enabled,true)},
 ...
 {name=NS.lsp_workspace_formatting,   rhs=require("hc-nvim.util.function.format_workspace").format_workspace,              cond=has_cap("textDocument/formatting")},
 {name=NS.lsp_workspace_list_folders, rhs=HCNvim.Util.Wrapper.fn_eval(vim.print,vim.lsp.buf.list_workspace_folders),       cond=has_cap("workspace/workspaceFolders")},
