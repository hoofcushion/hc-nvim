...
return Util.parse_override({
 ...
 },
 {
  {
   override={mode={"i"}},
   {name=NS.insert_delete,lhs="<c-s-h>"},
   {name=NS.insert_w,     lhs="<m-w>"},
   {name=NS.insert_b,     lhs="<m-b>"},
   {name=NS.insert_h,     lhs="<m-h>"},
   {name=NS.insert_j,     lhs="<m-j>"},
   {name=NS.insert_k,     lhs="<m-k>"},
   {name=NS.insert_l,     lhs="<m-l>"},
  },
 },
 {
  {
   override={mode={"c"}},
   {name=NS.cmdline_delete,lhs="<c-s-h>"},
   {name=NS.cmdline_h,     lhs="<m-h>"},
   {name=NS.cmdline_j,     lhs="<m-j>"},
   {name=NS.cmdline_k,     lhs="<m-k>"},
   {name=NS.cmdline_l,     lhs="<m-l>"},
  },
 },
 {
  ...
  {name=NS.lsp_declaration,            lhs={"gy","<leader>ly"}},
  {name=NS.lsp_definition,             lhs={"gl","<leader>ll"}},
  ...
  {name=NS.lsp_implementation,         lhs={"gY","<leader>lY"}},
  {name=NS.lsp_incoming_calls,         lhs="<leader>li"},
  {name=NS.lsp_outgoing_calls,         lhs="<leader>lo"},
  {name=NS.lsp_references,             lhs={"gz","<leader>lz"}},
  {name=NS.lsp_rename,                 lhs={"<F2>","gZ","<leader>lZ","<leader>lr"}},
  {name=NS.lsp_signatureHelp,          lhs={"gK","<leader>lj"}},
  {name=NS.lsp_typeDefinition,         lhs={"gL","<leader>lL"}},
  ...
  {name=NS.lsp_workspace_list_folders, lhs="<leader>lw"},
  {name=NS.lsp_workspace_remove_folder,lhs="<leader>lW"},
 ...
 -- @statement.outer
 {
  override={tags="nvim-treesitter-textobjects"},
  {
   override={mode={"x","o"}},
   {
    {name=NS.ts_select_assignment_lhs,   lhs="ig",desc="Assignment lhs"},
    {name=NS.ts_select_assignment_rhs,   lhs="ih",desc="Assignment rhs"},
    {name=NS.ts_select_assignment_outer, lhs="ai",desc="Assignment"},
    {name=NS.ts_select_assignment_inner, lhs="ii",desc="Assignment"},
    {name=NS.ts_select_attribute_outer,  lhs="at",desc="Attribute"},
    {name=NS.ts_select_attribute_inner,  lhs="it",desc="Attribute"},
    {name=NS.ts_select_block_outer,      lhs="ab",desc="Block"},
    {name=NS.ts_select_block_inner,      lhs="ib",desc="Block"},
    {name=NS.ts_select_call_outer,       lhs="aa",desc="Call"},
    {name=NS.ts_select_call_inner,       lhs="ia",desc="Call"},
    {name=NS.ts_select_class_outer,      lhs="aC",desc="Class"},
    {name=NS.ts_select_class_inner,      lhs="iC",desc="Class"},
    {name=NS.ts_select_comment_outer,    lhs="ac",desc="Comment"},
    {name=NS.ts_select_comment_inner,    lhs="ic",desc="Comment"},
    {name=NS.ts_select_conditional_outer,lhs="ao",desc="Conditional"},
    {name=NS.ts_select_conditional_inner,lhs="io",desc="Conditional"},
    {name=NS.ts_select_frame_outer,      lhs="aF",desc="Frame"},
    {name=NS.ts_select_frame_inner,      lhs="iF",desc="Frame"},
    {name=NS.ts_select_function_outer,   lhs="af",desc="Function"},
    {name=NS.ts_select_function_inner,   lhs="if",desc="Function"},
    {name=NS.ts_select_loop_outer,       lhs="al",desc="Loop"},
    {name=NS.ts_select_loop_inner,       lhs="il",desc="Loop"},
    {name=NS.ts_select_number_inner,     lhs="in",desc="Number"},
    {name=NS.ts_select_parameter_outer,  lhs="aP",desc="Parameter"},
    {name=NS.ts_select_parameter_inner,  lhs="iP",desc="Parameter"},
    {name=NS.ts_select_regex_outer,      lhs="aR",desc="Regex"},
    {name=NS.ts_select_regex_inner,      lhs="iR",desc="Regex"},
    {name=NS.ts_select_return_outer,     lhs="ar",desc="Return"},
    {name=NS.ts_select_return_inner,     lhs="ir",desc="Return"},
    {name=NS.ts_select_scopename_inner,  lhs="iS",desc="Scopename"},
    {name=NS.ts_select_statement_outer,  lhs="aS",desc="Statement"},
   },
  },
  {
   override={mode={"n","x","o"}},
   {
    {name=NS.ts_move_next_function,   lhs="]f",desc="Next function"},
    {name=NS.ts_move_next_class,      lhs="]F",desc="Next class"},
    {name=NS.ts_move_next_scope,      lhs="]S",desc="Next scope"},
    {name=NS.ts_move_next_parameter,  lhs="]P",desc="Next parameter"},
    {name=NS.ts_move_next_comment,    lhs="]c",desc="Next comment"},
    {name=NS.ts_move_next_conditional,lhs="]C",desc="Next condition"},
    {name=NS.ts_move_next_fold,       lhs="]z",desc="Next fold"},
   },
  },
  {
   override={mode={"n","x","o"}},
   {
    {name=NS.ts_move_prev_function,   lhs="[f",desc="Prev function"},
    {name=NS.ts_move_prev_class,      lhs="[F",desc="Prev class"},
    {name=NS.ts_move_prev_scope,      lhs="[S",desc="Prev scope"},
    {name=NS.ts_move_prev_parameter,  lhs="[P",desc="Prev parameter"},
    {name=NS.ts_move_prev_comment,    lhs="[c",desc="Prev comment"},
    {name=NS.ts_move_prev_conditional,lhs="[C",desc="Prev condition"},
    {name=NS.ts_move_prev_fold,       lhs="[z",desc="Prev fold"},
   },
  },
 },
 {
