return {
 ...
 o={
  ...
  --- Indentation ---
  tabstop=4,         -- How many spaces that tab expand for
  shiftwidth=4,      -- How many spaces that a indentation needs
  -- expandtab=false,    -- Use spaces instead of tabs for indentation
