...
return {
 ...
 {name=NS.flash_jump_e,                 rhs=W.fn_with(flash.jump,pattern.e)},
 {name=NS.flash_jump_ge,                rhs=W.fn_with(flash.jump,pattern.ge)},
 {name=NS.flash_jump_line,              rhs=W.fn_with(flash.jump,pattern.line)},
 {name=NS.flash_jump_line_non_blank,    rhs=W.fn_with(flash.jump,pattern.line_non_blank)},
 {name=NS.flash_jump_line_end,          rhs=W.fn_with(flash.jump,pattern.line_end)},
 {name=NS.flash_jump_line_end_non_blank,rhs=W.fn_with(flash.jump,pattern.line_end_non_blank)},
 ...
 {name=NS.flash_treesitter_start,       rhs=W.fn_with(flash_ts.search,pattern.line)},
 {name=NS.flash_remote,                 rhs=flash.remote},
 {name=NS.flash_remote_line,            rhs=W.fn_with(flash.remote,pattern.line)},
